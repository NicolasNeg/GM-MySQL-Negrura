#define RECORDING "2camionero" //Aqui ponemos el nombre del arvhivo que grabaste
#define RECORDING_TYPE 1  //<<--- Aqui va un 1 si tu NPC es en vehículo y un 2 si es a Pie
